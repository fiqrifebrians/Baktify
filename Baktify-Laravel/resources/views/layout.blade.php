...
<head>
    ...
    <title>@yield('title', 'Backtify')</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark justify-content-between">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{route('homepage')}}">Backtify</a>
        <!-- Sidebar Toggle-->
        <!-- Navbar Search-->
    ...
    <script src="https://cdnjs.c    udflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
